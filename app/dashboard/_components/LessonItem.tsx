        ...
        >
            <div className="flex items-center gap-2 w-full min-w-0">
                <div className="shrink-0">
                    ...
                    {completed ?(
                        <div className="size-5 rounded-full border-2 bg-green-600 dark:bg-green-500 flex justify-center items-center">
                ...
                <div className="flex-1 text-left min-w-0">
                    ...
                    {completed && <p className="text-[10px] text-green-700 dark:text-green-300">Completed</p>}
                </div>
            </div>
        </Link>
    )
